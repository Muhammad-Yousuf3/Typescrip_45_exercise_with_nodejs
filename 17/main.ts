...
console.log("Sorry Boys! Unfortunately dinner table will not arrive on time so on only 2 of you can come on dinner.");
while (guestList.length > 2) {
    let removedGuests=guestList.pop();
    console.log("Sorry",removedGuests,"I can't invite you on dinner");
}
guestList.forEach(guest => console.log(`${guest}`,"You are still invited on dinner."));
