function make_album(artist_name:string , album_name:string , tracks?:any){
    let album:{artist:string,title:string,tracks?:string}={artist:artist_name,title:album_name};
    if (tracks !== undefined) {
        album.tracks=tracks;
    }
    return album;
